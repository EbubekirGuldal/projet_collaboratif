 ...
 */
final class Version20260312085655 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE moderation_log DROP target_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE moderation_log ADD target_id INT DEFAULT NULL');
    }
}
