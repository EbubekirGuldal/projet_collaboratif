...
final class ProfileController extends AbstractController
{
    ...
    #[Route('/profile/created-resources', name: 'app_profile_created_resources', methods: ['GET'])]
    public function createdResources(Request $request): Response
    {
        /** @var User|null $user */
        $user = $this->getUser();
        if (!$user) {
        ...
        return $this->render('profile/created_resources.html.twig', [
    ...
    public function updateProfilePhoto(Request $request): Response
    {
        ...
        if ($pictureFile->getError() !== \UPLOAD_ERR_OK) {
            $this->addFlash('warning', 'Le fichier n a pas pu être téléversé.');
     ...
     *
     * @return array{resources: Resource[], query: string, sort: string}
     */
    private function buildResourceListing(array $resources, Request $request): array
    {
