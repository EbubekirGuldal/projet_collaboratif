...
class CommentCrudController extends AbstractCrudController
{
    ...
    {
        return $crud
            ->setSearchFields(['id', 'content', 'status', 'resource.title', 'resource.id', 'user.email', 'user.username'])
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            ChoiceField::new('status', 'Statut')
                ->setChoices([
                    'En attente' => CommentStatus::PENDING,
                    'Approuve' => CommentStatus::APPROVED,
                    'Rejete' => CommentStatus::REJECTED,
                ]),
            AssociationField::new('resource', 'Ressource'),
